...
array3D GeoRaster::readValues3D(unsigned row, unsigned nrows, unsigned col, unsigned ncols){
...
std::vector<double> GeoRaster::readValues3D2R(unsigned row, unsigned nrows, unsigned col, unsigned ncols){
	
	boost::multi_array<double, 3> m = GeoRaster::readValues3D(row, nrows, col, ncols);
