...
static void __err_handler(CPLErr eErrClass, int err_no, const char *msg) {
	...
	switch ( eErrClass ) {
        ...
        case 1:
        case 2:
			m = "GDAL warning" + std::to_string(err_no) +":" + std::string(msg) + "\n";
			break; // #nocov
        case 3:
			m = "GDAL error" + std::to_string(err_no) +":" + std::string(msg) + "\n";
            break;
        case 4:
			m = "GDAL error" + std::to_string(err_no) +":" + std::string(msg) + "\n";
            break;
        default:
			m = "Unknown GDAL error: " + std::to_string(eErrClass) + "\n" + std::to_string(err_no) +":" + std::string(msg) + "\n";
            break; // #nocov
    }
    std::cout << m << std::endl;
    return;
